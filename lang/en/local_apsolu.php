...
$string['apsolu:editgrades'] = 'Saisir les notes';
...
$string['apsolu:resetsettings'] = 'Modifier les paramètres de réinitialisation des espaces-cours.';
...
$string['activity_without_constraint'] = 'Activité sans contrainte particulière';
$string['activity_with_specific_constraints'] = 'Activité à contraintes particulières';
$string['activity_X_without_constraint'] = 'Activité {$a} sans contrainte particulière';
$string['activity_X_with_specific_constraints'] = 'Activité {$a} à contraintes particulières';
$string['add_attendance_status'] = 'Ajouter un type de présence';
$string['add_area'] = 'Ajouter une zone géographique';
$string['add_association_number'] = 'Ajouter un numéro de section';
$string['add_bulk_sessions'] = 'Ajouter une série de sessions';
...
$string['add_holiday'] = 'Ajouter un jour férié';
$string['additional_fields_to_display'] = 'Champs additionnels à afficher';
...
$string['add_location'] = 'Ajouter un lieu';
$string['add_locations_manager'] = 'Ajouter un gestionnaire de lieux';
...
$string['after_the_session'] = 'Après la session';
...
$string['a_license_number_request_is_being_processed'] = 'Une demande de numéro de licence est en cours de traitement. Merci de vous rapprocher de votre secrétariat pour annuler votre inscription à la FFSU.';
$string['all_cities'] = 'Tous les sites';
$string['all_courses'] = 'Tous les créneaux';
$string['all_attendances_taken_with_this_status_will_be_deleted'] = 'Toutes les présences prises avec ce type de présence seront effacées.';
$string['allow_to_choose_or_not_a_replyto_address'] = 'Autoriser l’utilisateur à sélectionner ou non une adresse de « réponse à »';
$string['allow_students_who_are_not_enrolled_in_the_course'] = 'Autoriser les étudiants non-inscrits au cours';
$string['allow_students_who_are_not_enrolled_in_the_course_help'] = 'Permet de valider une présence aux étudiants non-inscrits au cours. Si la valeur est positionnée à « Non », aucune présence ne sera prise en compte pour les étudiants non-inscrits.';
$string['an_error_occurred_while_creating_record'] = 'Une erreur est survenue lors de la création de l’enregistrement.';
$string['an_error_occurred_while_deleting_record'] = 'Une erreur est survenue lors de la suppression de l’enregistrement.';
$string['an_error_occurred_while_saving_data'] = 'Une erreur est survenue lors de l’enregistrement des données.';
...
$string['assign_status_to_students_without_attendance'] = 'Attribuer un type de présence aux étudiants sans présence';
$string['assign_status_to_students_without_attendance_help'] = 'Permet d’attribuer automatiquement après la session un type de présence à tous les étudiants n’ayant pas validé une présence pour la session.';
$string['associationdescription'] = 'Pour participer aux compétitions, aux rencontres';
$string['association'] = 'Licence FFSU';
$string['association_number_has_been_deleted'] = 'Le numéro de section a été supprimé.';
$string['association_number'] = 'Numéro de section';
$string['association_number_help'] = 'Numéro de section de votre association sportive.

Si votre association n’a pas de section, saisissez n’importe quelle lettre.';
$string['association_number_prefix'] = 'Préfixe de numéro de section';
$string['association_number_saved'] = 'Numéro de section enregistré';
$string['association_numbers_help'] = 'Critères permettant d’attribuer un numéro de section à un utilisateur.

Les critères sont testés dans l’ordre d’affichage.

Dès qu’un critère correspond à un utilisateur, le numéro de section est associé à l’utilisateur.';
$string['association_numbers'] = 'Numéros de section';
$string['association_number_updated'] = 'Numéro de section modifié';
...
$string['attendance_status_has_been_deleted'] = 'Le type de présence a été supprimé.';
...
$string['authorisation_for_commercial_offers'] = 'Autorisation offres commerciales';
$string['authorisation_for_data_use'] = 'Autorisation utilisation des données';
$string['authorisation_for_newsletter'] = 'Autorisation newsletter';
$string['authorizations'] = 'Autorisations';
$string['automatically_log_out_of_your_account_once_the_qr_code_is_displayed'] = 'Déconnecter automatiquement votre compte une fois le QR code affiché';
$string['automatically_log_out_of_your_account_once_the_qr_code_is_displayed_help'] = 'Permet de déconnecter l’enseignant du site. Ce paramètre peut être utile si l’appareil servant à afficher le QR code est laissé sans surveillance.';
$string['background_image'] = 'Image de fond';
$string['before_being_able_to_request_a_license_you_must'] = 'Avant de pouvoir effectuer votre demande de licence, vous devez :';
$string['before_the_start_of_the_session'] = 'Avant la session';
$string['beware_of_default_settings'] = 'Attention, les paramètres ci-dessous correspondent aux valeurs par défaut. Certaines sessions ont peut-être été modifiées : cliquez sur Enregistrer ou Générer pour appliquer les mêmes paramètres à tous les QR codes.';
...
$string['birthtown'] = 'Commune de naissance';
$string['blue'] = 'Bleu';
$string['building'] = 'Bâtiment';
...
$string['by_default_copy_functional_contact'] = 'Par défaut, mettre en copie le contact fonctionnel';
...
$string['cancel_and_unenrol_link'] = '<a id="apsolu-cancel-a" href="{$a->href}" class="{$a->class}">Annuler et se désinscrire</a>';
...
$string['card_has_been_deleted'] = 'Le tarif a été supprimé.';
$string['card_shortname_help'] = 'Libellé affiché aux étudiants.';
$string['card_shortname'] = 'Nom abrégé';
$string['cardholder_additional_postal_address_optional'] = 'Complément de l’adresse postale du porteur de carte (facultatif)';
$string['cardholder_city'] = 'Ville du porteur de carte';
$string['cardholder_country'] = 'Pays du porteur de carte';
$string['cardholder_firstname'] = 'Prénom du porteur de carte';
...
$string['code_to_use_in_the_fullname_course_template'] = 'Code à utiliser dans le modèle du nom complet de cours : <b>{$a}</b>';
...
$string['certificate_date'] = 'Date du certificat';
$string['certificate_status'] = 'État du certificat';
$string['certificates_validation'] = 'Validation de certificats';
$string['change_status'] = 'Délai pour changer le type de présence après le début de la session';
...
$string['commercial_offers'] = 'Offres commerciales';
...
$string['course_type'] = 'Format d’activités';
$string['course_type_add'] = 'Ajouter un format d’activités';
$string['course_type_cannot_be_deleted'] = 'Le format d’activités « {$a} » ne peut pas être supprimé, car il est rattaché aux cours suivants :';
$string['course_type_cannot_be_deleted_because_this_is_the_last_one'] = 'Le dernier format d’activités ne peut pas être supprimé. Il doit rester au minimum un format d’activités.';
$string['course_type_has_been_deleted'] = 'Le format d’activités a été supprimé.';
$string['course_type_name'] = 'Nom du format d’activités';
$string['course_type_saved'] = 'Format d’activités enregistré';
$string['course_type_updated'] = 'Format d’activités modifié';
$string['course_types'] = 'Formats d’activités';
$string['course_types_customfields'] = 'Champs personnalisés des formats d’activités';
$string['course_types_list'] = 'Liste des formats d’activités';
...
$string['dashboard_message'] = 'Message du tableau de bord';
$string['dashboardheader'] = 'Message d’entête';
$string['dashboardheader_help'] = 'Une fois activé, ce bandeau sera affiché au-dessus du contenu du tableau de bord.';
$string['data_has_been_deleted'] = 'Les données ont été supprimées.';
$string['data_saved'] = 'Données enregistrées.';
$string['data_updated'] = 'Données modifiées.';
$string['data_unsaved'] = 'Modifications non enregistrées.';
$string['data_unsaved_confirm_or_cancel'] = 'Des modifications non enregistrées ont été détectées, cliquez sur continuer pour ignorer cet avertissement (les modifications seront perdues).';
$string['date'] = 'Date';
$string['dates'] = 'Dates';
...
$string['disability'] = 'Handicap';
$string['disable_replyto'] = 'Désactiver la possibilité de définir une adresse de « réponse à »';
$string['discipline'] = 'Discipline';
$string['discipline_additional_information'] = '3 choix maximum pour les disciplines secondaires.<br />Les sports suivants nécessitent un certificat médical : {$a}.';
$string['discipline_cursus'] = 'Discipline / cursus';
$string['discipline_cursus_shortened'] = 'Discipline cursus';
$string['discipline_primary'] = 'Discipline principale';
$string['disciplines'] = 'Disciplines';
$string['disciplines_secondary'] = 'Disciplines secondaires';
...
$string['do_not_use'] = 'ne pas utiliser';
...
$string['do_you_want_to_delete_association_number'] = 'Voulez-vous supprimer le numéro de section « {$a} » ?';
...
$string['do_you_want_to_delete_course_type'] = 'Voulez-vous supprimer le format d’activités « {$a} » ?';
...
$string['doctor_name'] = 'Nom du médecin';
$string['doctor_rpps'] = 'RPPS du médecin';
$string['during_the_session'] = 'Après le début de la session';
$string['edit_attendance_status'] = 'Modifier un type de présence';
$string['edit_area'] = 'Modifier une zone géographique';
$string['edit_association_number'] = 'Modifier un numéro de section';
$string['edit_category'] = 'Modifier une activité physique';
$string['edit_city'] = 'Modifier un site';
$string['edit_course'] = 'Modifier un créneau horaire';
$string['edit_course_of_type_X'] = 'Modifier un créneau horaire ({$a})';
$string['edit_course_type'] = 'Modifier un format d’activités';
$string['edit_gradeitem'] = 'Modifier un élément d’évaluation';
$string['edit_grouping'] = 'Modifier un groupement d’activités';
$string['edit_holiday'] = 'Modifier un jour férié';
$string['edit_location'] = 'Modifier un lieu';
$string['edit_locations_manager'] = 'Modifier un gestionnaire de lieux';
$string['edit_matching'] = 'Modifier la correspondance';
$string['edit_payment'] = 'Modifier un paiement';
$string['edit_period'] = 'Modifier une période';
$string['edit_qr_code'] = 'Paramètres';
$string['edit_role'] = 'Modifier un type d’inscription';
$string['edit_skill'] = 'Modifier un niveau de pratique';
$string['email_primary_legal_representative'] = 'Courriel du représentant légal';
$string['email_primary_legal_representative_shortened'] = 'Mail du représentant légal';
...
$string['enable_attendance_recordings_via_qr_codes'] = 'Activer la saisie de présences par QR codes';
$string['enable_change_of_attendance_type'] = 'Activer le changement de type de présence après le début de la session';
...
$string['enable_dismiss'] = 'Présence d’un bouton « Fermer »';
$string['enable_header_message'] = 'Activer l’affichage du message';
...
$string['enable_stop_of_attendance_recordings'] = 'Activer l’arrêt des prises de présences après le début de la session';
$string['end_date'] = 'Date de fin';
$string['end_day'] = 'Jour de fin';
...
$string['enrol_overview_message'] = 'Informations préalables à l’inscription';
...
$string['exclude_holidays'] = 'Exclure les jours fériés';
...
$string['exporting_users'] = 'Exportation des utilisateurs';
$string['export_settings'] = 'Paramètres d’exportation';
$string['export_to_csv_format'] = 'Exporter au format CSV';
$string['export_to_excel_format'] = 'Exporter au format Excel';
$string['federal_texts'] = 'Textes fédéraux';
...
$string['field'] = 'Champ';
$string['field_fieldname'] = 'Champ « {$a} »';
$string['fields'] = 'Champs';
$string['fields_associated_with_this_format_type'] = 'Champs associés à ce format d’activités';
$string['field_X_cannot_be_empty'] = 'Le champ « {$a} » ne peut pas être vide.';
$string['field_X_must_be_selected_code_X'] = 'Le champ « {$a->name} » doit être sélectionné (code {$a->code}).';
$string['fill_out_the_membership_form'] = 'Remplir le formulaire d’adhésion';
$string['filter'] = 'Filtrer';
$string['firstname_primary_legal_representative'] = 'Prénom du représentant légal';
$string['firstname_secondary_legal_representative'] = 'Prénom du représentant légal secondaire';
...
$string['generate_a_qr_code'] = 'Générer un QR code';
$string['generate_all_qr_codes'] = 'Générer les QR codes';
$string['generate_a_qr_code_for'] = 'Session(s) concernée(s)';
$string['generate_holidays'] = 'Générer les jours fériés';
$string['grade_has_been_deleted'] = 'La note a été supprimée.';
$string['grade_has_not_been_deleted'] = 'La note n’a pas été supprimée.';
$string['gradeitem'] = 'Élément d’évaluation';
$string['gradeitem_add'] = 'Ajouter un élément d’évaluation';
$string['gradeitem_has_been_deleted'] = 'L’élément d’évaluation a été supprimé.';
$string['gradeitem_name'] = 'Nom de l’élement d’évaluation';
$string['gradeitem_name_help'] = 'Exemples: note de pratique, théorie, etc';
$string['gradeitem_saved'] = 'Élément d’évaluation enregistré.';
$string['gradeitem_updated'] = 'Élément d’évaluation modifié.';
$string['gradeitems'] = 'Éléments d’évaluation';
$string['gradeitems_list'] = 'Liste des éléments d’évaluation';
...
$string['headermessage_help'] = 'Une fois activé, ce bandeau d’informations sera affiché dans l’en-tête de toutes les pages à l’exception de la page d’accueil';
$string['headers'] = 'Bandeaux personnalisés';
...
$string['high_level_athlete'] = 'Sportif de haut niveau';
$string['holiday'] = 'Jour férié';
$string['holiday_has_been_deleted'] = 'Le jour férié a été supprimé.';
$string['holiday_saved'] = 'Jour férié enregistré.';
$string['holiday_updated'] = 'Jour férié modifié.';
$string['holidays'] = 'Jours fériés';
$string['holidays_have_been_generated'] = 'Les jours fériés ont été générés.';
$string['holidays_have_been_purged'] = 'La liste des jours fériés a été vidée.';
$string['holidays_list'] = 'Liste des jours fériés';
$string['home'] = 'Accueil';
$string['honorability'] = 'Honorabilité';
$string['honorability_shortened'] = 'Honorabilite';
...
$string['if_the_section_number_is_not_an_11-digit_number_the_section_column_will_be_empty'] = 'Si le numéro de section n’est pas un nombre composé de 11 chiffres, la colonne « section » dans l’export Excel sera vide.';
...
$string['i_wish_to_practice_an_activity_with_particular_constraints_and_certify_that_i_have_presented_a_medical_certificate_short'] = 'Je souhaite pratiquer une activité à contraintes particulières...';
$string['i_wish_to_practice_an_complementary_activity_with_particular_constraints_and_certify_that_i_have_presented_a_medical_certificate'] = 'Je souhaite pratiquer une activité à contraintes particulières. Je dois présenter un certificat médical, mentionnant cette activité, de non-contre-indication à la pratique en compétition de moins d’un an.';
...
$string['identity'] = 'Identité';
$string['image_rights'] = 'Droit à l’image';
$string['image_rights_help'] = 'J’autorise la FFSU, ses organes déconcentrés et l’A.S. à exploiter toutes les photos et vidéos prises dans le cadre des activités fédérales pour des actions publicitaires ou promotionnelles. Cette autorisation est consentie pour le territoire français et une durée de 10 ans à compter de la captation de mon image. Je suis informé(e) que je dispose d’un droit d’accès, de modification, de rectification et de suppression des données qui le concerne (art. 34 de la loi ” Informatique et Libertés “), soit par mon espace personnel, soit en contactant directement la FFSU.';
...
$string['invalid_paid_amount'] = 'Montant invalide : saisir un montant supérieur à 0 ou sélectionner le statut « {$a} »';
$string['invalid_partial_amount'] = 'Veuillez saisir un montant partiel supérieur à 0';
$string['invalid_payment_gift_status'] = 'Impossible de choisir le statut « {$a} » si la totalité du paiement est effectuée via Atouts Normandie.';
...
$string['lastname'] = 'Nom';
$string['lastname_primary_legal_representative'] = 'Nom du représentant légal';
$string['lastname_secondary_legal_representative'] = 'Nom du représentant légal secondaire';
$string['legal_authorisation'] = 'Autorisation légale';
...
$string['license_number_status'] = 'État du numéro de licence';
$string['license_paid'] = 'Licence payée';
$string['license_payment_status'] = 'État du paiement de licence';
$string['license_type'] = 'Type de licence';
$string['licensee_type'] = 'Type de licencié';
$string['lieudit'] = 'Lieu dit';
$string['list_of_due_payments'] = 'Cartes non payées';
...
$string['member_code'] = 'Code adhérent';
...
$string['medical_certificate_date_shortened'] = 'Date Certificat Médical';
...
<p>Cordialement,</p>';
$string['medical_certificate_refusal_message_for_mention_missing_subject'] = '[FFSU] Refus de votre certificat médical';
$string['medical_certificate_refusal_message_for_one_year_expiration_body'] = '<p>Bonjour,</p>
<p>Nous ne pouvons valider votre certificat médical car il a plus d’un an (activité à contrainte particulière).</p>
<p>Merci de retourner sur la page du formulaire d’adhésion, de supprimer votre certificat actuel et de déposer un nouveau certificat médical valide.</p>
<p>Cordialement,</p>';
$string['medical_certificate_refusal_message_for_one_year_expiration_subject'] = '[FFSU] Refus de votre certificat médical';
$string['medical_certificate_refusal_message_for_six_months_expiration_body'] = '<p>Bonjour,</p>
<p>Nous ne pouvons valider votre certificat médical il a plus de 6 mois.</p>
<p>Merci de retourner sur la page du formulaire d’adhésion, de supprimer votre certificat actuel et de déposer un nouveau certificat médical valide.</p>
<p>Cordialement,</p>';
...
$string['medical_certificate_validated_shortened'] = 'Certificat Médical validé';
...
$string['mention_missing'] = 'Mention manquante';
$string['message'] = 'Message';
$string['message_sent'] = 'Message envoyé';
$string['messages_sent_to_X_users'] = 'Messages envoyés à {$a} utilisateurs';
$string['messaging'] = 'Messagerie';
$string['midday'] = 'Midi';
$string['mister'] = 'Monsieur';
$string['modify'] = 'Modifier';
$string['monday'] = 'Lundi';
$string['more_than_one_year'] = 'Plus d’un an';
$string['more_than_six_months'] = 'Plus de six mois';
...
$string['negative_health_questionnaire'] = 'Questionnaire Santé Négatif';
$string['new_message'] = 'Nouveau message';
$string['new_sessions_for_course_X'] = 'Nouvelles sessions pour le cours {$a}';
$string['newsletter'] = 'Lettre d’informations';
...
$string['no_course_types'] = 'Aucun format d’activités';
$string['no_qrcode_found'] = 'Aucun QR code existant pour la session indiquée. Merci de générer un QR code avant de le modifier ou de l’imprimer';
$string['no_files'] = 'Aucun fichier';
$string['no_gradeitems'] = 'Aucun élément d’évaluation';
$string['no_grades'] = 'Aucune note';
$string['no_histories'] = 'Aucun historique';
$string['no_holidays'] = 'Aucun jour férié';
$string['no_messages_sent_to_forum'] = 'Aucun message publié dans le forum du cours.';
$string['no_payment_card'] = 'Veuillez sélectionner au moins une des cartes.';
...
$string['no_sessions_created'] = 'Aucune session créée.';
$string['no_sessions_will_be_created_with_these_settings'] = 'Aucune session ne se sera créée avec ces paramètres.';
$string['no_students'] = 'Aucun étudiant';
$string['no_templates'] = 'Aucun modèle';
$string['no_users'] = 'Aucun utilisateur';
$string['no_users_found_with_these_search_criteria'] = 'Aucun utilisateur trouvé avec ces critères de recherche';
...
$string['not_allowed_qrcode_display'] = 'Désolée, vous n’avez actuellement pas les permissions requises pour accéder à cette page (affichage de QR code)';
...
$string['open_attendance_recording'] = 'Délai d’ouverture de la saisie de présences avant le début de la session';
$string['open_attendance_recording_help'] = 'Permet d’ouvrir la saisie de présences avant l’heure de début de la session. Si la valeur utilisée est 0, le QR code sera utilisable au démarrage de la session.';
$string['options'] = 'Options';
$string['orange'] = 'Orange';
$string['other_federation'] = 'Autre fédération';
$string['other_filters'] = 'Autres filtres';
$string['overviewheader'] = 'Message d’entête';
$string['overviewheader_help'] = 'Une fois activé, ce bandeau d’informations sera affiché au dessus du tableau des inscriptions';
...
$string['partial_amount'] = 'sur une partie du montant';
...
J’autorise :';
$string['personal_address'] = 'Coordonnées personnelles';
$string['phone1'] = 'Tél. fixe';
$string['phone2'] = 'Tél. mobile';
$string['phone'] = 'Numéro de téléphone';
$string['phone_help'] = 'Le numéro de téléphone doit contenir 10 chiffres.';
$string['phone_primary_legal_representative'] = 'Téléphone du représentant légal';
$string['phone_primary_legal_representative_shortened'] = 'Tél. du représentant légal';
$string['phone_secondary_legal_representative'] = 'Téléphone du représentant légal secondaire';
$string['phone_secondary_legal_representative_shortened'] = 'Tél. du représentant légal secondaire';
...
$string['print_qrcodes_not_available'] = 'Impossible d’imprimer les QR codes du cours : certains n’ont pas encore été générés ou sont définis comme rotatifs.';
$string['publication_date'] = 'Date de publication';
$string['purge_holidays'] = 'Vider la liste des jours fériés';
$string['qr_code'] = 'QR code';
$string['qr_codes_settings'] = 'Paramètres des QR codes';
$string['qr_code_created'] = 'QR code créé.';
$string['qr_code_deleted'] = 'QR code supprimé.';
$string['qr_code_function_is_not_enabled'] = 'La fonction QR code n’est pas activée.';
$string['qr_code_setup'] = 'Gestion du QR code';
$string['qr_code_updated'] = 'QR code modifié.';
$string['qrcode_navigation_help'] = 'Cliquez sur le lien pour retourner à la vue par sessions';
...
$string['refuse_with_reasons_X'] = 'Refuser (raison : {$a})';
$string['registration_status'] = 'État de l’inscription';
$string['replyto_address_preference_help'] = 'Définit si l’adresse de courriel de l’utilisateur doit être utilisée dans le champ « réponse à ».';
$string['replyto_address_preference'] = 'Préférence pour l’adresse « réponse à »';
...
$string['rotate_qr_code'] = 'QR code rotatif';
$string['rotate_qr_code_help'] = 'Permet de générer un nouveau QR code toutes les 30 secondes. Ce paramètre peut permettre de limiter la diffusion du QR code et les prises de présences non légitimes.';
$string['rotate_qr_code_noprint_mode'] = 'Attention, le QR code étant définit comme rotatif (il se renouvelle automatiquement toutes les 30s), le module d’impression est désactivé.';
...
$string['school_certificate_validated'] = 'Certificat de scolarité validé';
$string['secondary_legal_representative'] = 'Représentant légal secondaire';
...
$string['session_:activity:_:type:'] = '{$a->activity} - {$a->type}';
...
$string['session_from_the_X_to_the_Y'] = 'Session du {$a->starttime} à {$a->endtime}';
...
$string['show_a_new_qr_code'] = 'Générer et afficher le QR code';
...
$string['show_area_filter_help'] = 'Affiche le filtre de la colonne « zone géographique » sur l’offre de formation.';
$string['show_category_column'] = 'Afficher l’activité';
$string['show_category_column_help'] = 'Affiche la colonne « activité » sur l’offre de formation.';
$string['show_category_filter'] = 'Afficher le filtre activité';
$string['show_category_filter_help'] = 'Affiche le filtre de la colonne « activité » sur l’offre de formation.';
$string['show_city_column'] = 'Afficher le site de pratique';
$string['show_city_column_help'] = 'Affiche la colonne « site » sur l’offre de formation.';
$string['show_city_filter'] = 'Afficher le filtre site de pratique';
$string['show_city_filter_help'] = 'Affiche le filtre de la colonne « site » sur l’offre de formation.';
$string['show_columns'] = 'Affichage des colonnes';
$string['show_filters'] = 'Affichage des filtres';
$string['show_grouping_column'] = 'Afficher le groupement d’activités';
$string['show_grouping_column_help'] = 'Affiche la colonne « groupement d’activités » sur l’offre de formation.';
$string['show_grouping_filter'] = 'Afficher le filtre groupement d’activités';
$string['show_grouping_filter_help'] = 'Affiche le filtre de la colonne « groupement d’activités » sur l’offre de formation.';
$string['show_location_column'] = 'Afficher le lieu de pratique';
$string['show_location_column_help'] = 'Affiche la colonne « lieu » sur l’offre de formation.';
$string['show_location_filter'] = 'Afficher le filtre lieu de pratique';
$string['show_location_filter_help'] = 'Affiche le filtre de la colonne « lieu » sur l’offre de formation.';
$string['show_period_column'] = 'Afficher la période';
...
$string['show_role_filter_help'] = 'Affiche le filtre de la colonne « type d’inscription » sur l’offre de formation.';
$string['show_skill_column'] = 'Afficher le niveau de pratique';
$string['show_skill_column_help'] = 'Affiche la colonne « niveau » sur l’offre de formation.';
$string['show_skill_filter'] = 'Afficher le filtre niveau de pratique';
$string['show_skill_filter_help'] = 'Affiche le filtre de la colonne « niveau » sur l’offre de formation.';
$string['show_teachers_column'] = 'Afficher les enseignants';
$string['show_teachers_column_help'] = 'Affiche la colonne « enseignants » sur l’offre de formation.';
$string['show_teachers_filter'] = 'Afficher le filtre enseignants';
$string['show_teachers_filter_help'] = 'Affiche le filtre de la colonne « enseignants » sur l’offre de formation.';
$string['show_times_column'] = 'Afficher la période de la journée';
$string['show_times_column_help'] = 'Affiche la colonne « périodes de la journée » sur l’offre de formation.';
$string['show_times_filter'] = 'Afficher le filtre période de la journée';
$string['show_times_filter_help'] = 'Affiche le filtre de la colonne « période de la journée » sur l’offre de formation.';
$string['show_weekday_column'] = 'Afficher le jour de la semaine';
$string['show_weekday_column_help'] = 'Affiche la colonne « jour » sur l’offre de formation.';
$string['show_weekday_filter'] = 'Afficher le filtre jour de la semaine';
$string['show_weekday_filter_help'] = 'Affiche le filtre de la colonne « jour » sur l’offre de formation.';
...
$string['site_and_location'] = 'SITE - Lieu';
...
$string['status_absent'] = 'Type de présence alors saisi';
$string['status_absent_help'] = 'Permet de définir le type de présence utilisé pour la prise de présences après la session de cours.';
$string['status_late'] = 'Type de présence alors saisi';
$string['status_late_help'] = 'Permet de définir le type de présence utilisé pour la prise de présences après le début de la session de cours.';
$string['status_present'] = 'Type de présence alors saisi';
$string['status_present_help'] = 'Permet de définir le type de présence utilisé pour la prise de présences avant et pendant la session de cours.';
$string['status_used'] = 'Type de présence utilisé';
$string['stop_taking_attendance'] = 'Délai pour l’arrêt de la prise de présences';
$string['stop_taking_attendance_help'] = 'Permet de définir un délai à partir duquel les présences ne sont plus prises en compte.';
$string['strftimedateshort'] = '%d/%m/%y';
$string['strftimedatetimefrom'] = '%A %d %B %Y de %Hh%M';
$string['strftimedatetimeshort'] = '%a %d %b %Y %H:%M';
$string['strftimedatetimesortable'] = '%F %T';
$string['strftimetime'] = '%Hh%M';
$string['student'] = 'Étudiant';
$string['students_found'] = '{$a} étudiant(s) trouvé(s)';
$string['student_shortened'] = 'Etudiant';
$string['studies'] = 'Études';
$string['study_cycle'] = 'Niveau';
$string['study'] = 'Étude';
$string['subject'] = 'Sujet';
$string['submit_qr_code'] = 'Générer un QR code';
$string['submit_qr_code_help'] = '<ul><li><li>Générer : créé ou renouvelle le QR code de la session avec les paramètres ci-dessus.</li>Enregistrer : modifie les paramètres du QR code de la session (sans créer de nouveau QR code).</li></ul>';
$string['submit_all_qr_codes'] = 'Générer les QR codes';
$string['submit_all_qr_codes_help'] = '<ul><li>Générer : créé ou renouvelle tous les QR codes des sessions à venir avec les paramètres ci-dessus.</li><li>Enregistrer : applique les paramètres aux QR codes de toutes les sessions à venir (sans générer de nouveaux codes). Si indisponible, cliquez sur Générer.</li><li>Imprimer : permet d’imprimer les QR codes existants pour les sessions à venir. Indisponible si tous les QR codes n’ont pas été générés ou si certains codes sont rotatifs.</li></ul>';
...
$string['task_for_notify_new_federation_adhesions'] = 'Tâche pour notifier des nouvelles adhésions à la FFSU';
...
$string['template_duplicated'] = 'Modèle de message dupliqué.';
$string['template_for_the_fullname_course'] = 'Modèle pour le nom complet du cours';
$string['template_for_the_fullname_course_example'] = '<small class="form-text text-muted">Exemple : « <b>{$a->category}</b> du <b>{$a->weekday}</b> niveau <b>{$a->skill}</b> » donnera le libellé de cours « <b>Tennis</b> du <b>mardi</b> niveau <b>expert</b> ».</small>';
$string['template_for_the_fullname_course_help'] = 'Modèle appliqué pour la génération du complet du cours.';
...
$string['terms_of_use_for_data'] = 'Conditions d’utilisation des données';
$string['terms_of_use_for_data_help'] = 'Je déclare avoir pris connaissance de la <a href="https://sport-u.com/la-ff-sport-u/" target="_blank">réglementation fédérale</a> et m’engage à la respecter. ';
$string['the_activities'] = 'Les activités';
$string['the_association_number_X_has_been_moved_to_Y_position'] = 'Le numéro de section « {$a->number} » a été déplacé en postion {$a->order}.';
$string['the_association_number_X_is_already_the_first_element'] = 'Le numéro de section « {$a} » est déjà le premier élément.';
$string['the_association_number_X_is_already_the_last_element'] = 'Le numéro de section « {$a} » est déjà le dernier élément.';
$string['the_attendance_recording_for_this_session_is_over'] = 'La prise de présences pour cette session est terminée.';
$string['the_attendance_recording_for_this_session_has_not_started_yet'] = 'La prise de présences pour cette session n’a pas encore débuté.';
$string['the_attendance_status_X_has_been_moved_to_Y_position'] = 'Le type de présence « {$a->label} » a été déplacé en postion {$a->order}.';
$string['the_attendance_status_X_is_already_the_first_element'] = 'Le type de présence « {$a} » est déjà le premier élément.';
$string['the_attendance_status_X_is_already_the_last_element'] = 'Le type de présence « {$a} » est déjà le dernier élément.';
...
$string['the_element_X_has_been_moved_to_Y_position'] = 'L’élement « {$a->name} » a été déplacé en postion {$a->order}.';
$string['the_element_X_is_already_the_first_element'] = 'L’élement « {$a} » est déjà le premier élément.';
$string['the_element_X_is_already_the_last_element'] = 'L’élement « {$a} » est déjà le dernier élément.';
...
$string['the_date_in_the_field_X_must_be_earlier_than_the_date_in_the_Y_field'] = 'La date du champ « {$a->field1} » doit être antérieure à la date du champ « {$a->field2} ».';
$string['the_date_in_the_field_X_must_be_later_than_the_date_in_the_Y_field'] = 'La date du champ « {$a->field1} » doit être postérieure à la date du champ « {$a->field2} ».';
...
$string['the_duration_of_the_X_field_must_be_greater_than_the_duration_of_the_Y_field'] = 'La durée du champ « {$a->field1} » doit être supérieure à la durée du champ « {$a->field2} ».';
$string['the_field_code_is_not_valid'] = 'Le code de champ « {$a} » n’est pas valide.';
$string['the_field_X_cannot_be_combined_with_the_field_Y'] = 'Le champ « {$a->field1} » ne peut pas être combiné avec le champ « {$a->field2} ».';
...
$string['the_field_X_must_be_checked_to_be_used_in_fullname_course_template'] = 'Le champ « {$a} » doit être coché pour être utilisé dans le modèle du libellé de cours.';
...
$string['the_following_sessions_have_been_created_for_the_course_X'] = 'Les sessions suivantes ont été créées pour le cours <a href="{$a->url}">{$a->name}</a> :';
...
$string['the_qr_code_does_not_exist_or_has_expired'] = 'Le QR code n’existe pas ou est expiré.';
$string['the_qrcode_session_has_expired'] = 'La session est expirée : modifier a posteriori les paramètres du QR code est susceptible d’entraîner des erreurs.';
$string['the_session_from_the_X_to_the_Y'] = 'la session du {$a->starttime} à {$a->endtime}';
$string['the_session_from_the_X_to_the_Y_collides_with_Z'] = 'La session du {$a->starttime} à {$a->endtime} entre en collision avec : {$a->sessions}.';
...
$string['the_value_must_be_greater_than_or_equal_to_X'] = 'La valeur doit être supérieure ou égale à {$a}.';
$string['this_activity_is_already_associated_with_activity_X'] = 'Cette activité est déjà associée à l’activité FFSU « {$a} »';
$string['this_association_number_is_already_used'] = 'Ce numéro de section est déjà utilisé';
...
$string['this_card_cannot_be_deleted_as_it_has_recently_used_in_X_transactions'] = 'Ce tarif ne peut pas être supprimé, car il a été utilisé récemment dans {$a} transactions.';
...
$string['title_primary_legal_representative'] = 'Civilité du représentant légal';
$string['title_secondary_legal_representative'] = 'Civilité du représentant légal secondaire';
$string['to'] = 'À';
$string['total'] = 'Total';
$string['total_amount'] = 'sur la totalité du montant';
$string['town'] = 'Commune';
$string['track_name'] = 'Nom de voie';
$string['track_number'] = 'N° de voie';
$string['track_type'] = 'Type de voie';
...
$string['undefined_federation_course'] = 'Cours FFSU non défini';
...
$string['use_atouts_payment'] = 'Utiliser Atouts Normandie';
...
$string['value_X_is_already_in_use_by_another_record'] = 'La valeur « {$a} » est déjà utilisée par un autre enregistrement.';
$string['visibility_of_fields'] = 'Visibilité des champs';
$string['visibility_of_field_X'] = 'Visibilité du champ « {$a} »';
$string['visible'] = 'Visible';
$string['visible_in_administration'] = 'Visible dans l’administration';
$string['visible_in_administration_help'] = 'Affiche le champ « {$a} » dans les colonnes de l’administration';
$string['visible_on_public_pages'] = 'Visible sur les pages publiques';
$string['visible_on_public_pages_help'] = 'Affiche le champ « {$a} » dans les colonnes des pages publiques';
...
$string['X_choices_at_the_most'] = '{$a} choix maximum';
...
$string['X_qr_codes_updated'] = '{$a} QR codes mis à jour';
$string['X_sessions_created'] = '{$a} session(s) créée(s)';
$string['X_sessions_will_be_created'] = '{$a} session(s) seront créée(s).';
$string['you_are_not_enrolled_in_this_course'] = 'Vous n’êtes pas inscrit à ce cours.';
$string['you_do_not_have_any_active_enrolments_for_this_course'] = 'Vous n’avez aucune inscription active pour ce cours.';
...
$string['you_must_select_at_least_one_value'] = 'Vous devez sélectionner au moins une valeur.';
...
$string['payments_enddate'] = 'Date de fin des paiements';
...
$string['attendance_delete_session'] = 'Supprimer la session « {$a->name} » ?';
$string['attendance_delete_session_with_functional_address'] = 'Supprimer la session « {$a->name} » ?<br />Note : l’adresse de contact « <em>{$a->email}</em> » sera notifiée de cette suppression.';
...
$string['attendance_excused_total'] = 'Total des dispensés';
$string['attendance_exempted'] = 'Excusé';
$string['attendance_exempted_short'] = 'E';
$string['attendance_exempted_style'] = 'info';
$string['attendance_exempted_total'] = 'Total des excusés';
...
$string['attendance_display_enrolments'] = 'Afficher les inscriptions {$a}';
$string['attendance_table_caption'] = 'Nombre d’inscrits potentiels : {$a} étudiant(s)';
$string['attendance_enrolment_state'] = '<abbr title="État de l’inscription">État</abbr>';
$string['attendance_presence'] = 'Présence';
$string['attendance_comment'] = 'Commentaire';
$string['attendance_presences_count'] = '<abbr title="Nombre">Nb</abbr> de présences';
$string['attendance_course_presences'] = 'Cours : {$a}';
$string['attendance_activity_presences'] = 'Activité : {$a}';
...
$string['attendance_valid_account'] = 'Compte Université valide';
...
$string['no_valid_payments'] = 'Aucun paiement valide. Cliquez sur « Afficher toutes les transaction » pour afficher les paiements dûs.';
...
$string['method_atouts'] = 'Atouts Normandie';
...
$string['definition_paid'] = 'paiement effectué';
$string['definition_due'] = 'paiement à effectuer';
$string['definition_free'] = 'pas de paiement à effectuer';
...
$string['settings_federation_export'] = 'Exportation des licences FFSU';
...
// Reinitialisation.
$string['settings_reset_courses'] = 'Réinitialisation des espaces-cours';
$string['settings_reset_courses_enabled'] = 'Réinitialisation des espaces-cours programmée';
$string['settings_reset_courses_updated'] = 'Réinitialisation des espaces-cours modifiée';
$string['settings_reset_courses_disabled'] = 'Réinitialisation des espaces-cours suspendue';
$string['settings_reset_courses_notify'] = 'Réinitialisation des espaces-cours à venir (rappel)';
$string['settings_reset_next'] = 'Configuration de la prochaine réinitialisation (rentrée {$a})';
$string['settings_reset_users_and_enrolments'] = 'Suppression des utilisateurs et des inscriptions';
$string['settings_reset_allusers'] = 'Supprimer tous les comptes utilisateurs (hors enseignants et gestionnaires)';
$string['settings_reset_allusers_help'] = 'Suppression de tous les comptes utilisateurs qui ne possèdent aucun rôle enseignant ou gestionnaire et ne sont pas administrateurs ou créateurs du cours.';
$string['settings_reset_oldusers'] = 'Supprimer les comptes des utilisateurs dont la dernière connexion remonte à plus d’un an';
$string['settings_reset_oldusers_help'] = 'Suppression des comptes inactifs depuis un an ou plus à l’exception des utilisateurs qui possèdent (sur le site ou dans un cours) un rôle enseignant ou gestionnnaire.';
$string['settings_reset_manualusers'] = 'Supprimer les comptes utilisateurs qui ne s’authentifient pas via un compte universitaire mais via un compte informatique local';
$string['settings_reset_manualusers_help'] = 'Suppression de tous les comptes utilisateurs « manuels » (comptes locaux créés dans Apsolu) à l’exception des utilisateurs qui possèdent (sur le site ou dans un cours) un rôle enseignant ou gestionnnaire. Attention : vos vacataires utilisent peut-être ce type d’authentification s’ils n’ont pas de compte universitaire.';
$string['settings_reset_userselectenrolments'] = 'Supprimer les voeux des utilisateurs (inscriptions sur listes principales, complémentaires, etc.)';
$string['settings_reset_selectenrolments'] = 'Supprimer les méthodes d’inscriptions par voeux dans les cours';
$string['settings_reset_cohortmembers'] = 'Vider les cohortes';
$string['settings_reset_user_infos'] = 'Suppression des données personnelles';
$string['settings_reset_userprofiles'] = 'Supprimer les informations de profil des utilisateurs (inscription, UFR, date de naissance, etc.)';
$string['settings_reset_userprofiles_help'] = 'Supprimer les informations sur l’inscription actuelle des utilisateurs (ces informations seront supprimées dans tous les cas si vous supprimez les comptes utilisateurs). Conserve les numéros de carte et licences ffsu.';
$string['settings_reset_userattendances'] = 'Supprimer les informations liées aux présences des utilisateurs';
$string['settings_reset_usergrades'] = 'Supprimer les notes des utilisateurs sur toutes les activités évaluées';
$string['settings_reset_userpayments'] = 'Supprimer les données relatives aux paiements des utilisateurs';
$string['settings_reset_userpolicies'] = 'Réinitialiser le témoin d’acceptation des recommandations médicales';
$string['settings_reset_courses_global'] = 'Réinitialisation des cours et contenus';
$string['settings_reset_sessions'] = 'Supprimer les sessions passées pour tous les cours';
$string['settings_reset_coursesvisibility'] = 'Masquer les différents créneaux proposés pour chaque activité';
$string['settings_reset_coursesvisibility_help'] = 'Positionnement du paramètre « visible » à false pour tous les cours (seule la liste des différentes activités reste visible).';
$string['settings_reset_coursescontent'] = 'Supprimer le paramétrage de base (APSA, lieux...)';
$string['settings_reset_globalconfigurations'] = 'Supprimer les espaces-cours et leurs contenus';
$string['settings_reset_metaenrolments'] = 'Supprimer toutes les méthodes d’inscription de type « méta-cours »';
$string['settings_reset_nextdatetime'] = 'Activer la tâche de réinitialisation des espaces-cours';
$string['settings_reset_nextdatetime_help'] = 'Si la campagne de réinitialisation est activée, le script sera exécuté à cette date avec les paramètres définis ci-dessus. Décochez la case « Activer » pour suspendre l’exécution du script. Un délai de minimum {$a}H est nécessaire avant de pouvoir prendre en compte la demande de réinitialisation.';
$string['settings_reset_nextruntime'] = 'Date de la prochaine exécution de la tâche';
$string['settings_reset_ffsu'] = 'Réinitialiser le cours lié à la FFSU';
$string['settings_reset_ffsu_help'] = 'Supprime les adhésions, les fichiers (autorisations, certificats...) et les méthodes d’inscription (les numéros de licence seront conservés)';
$string['reset_minimumdelayerror'] = 'La réinitialisation ne peut être programmée avant le {$a->datetime} (un délai de {$a->period}H est imposé pour validation).';
$string['reset_minimumfieldserror'] = 'La réinitialisation ne peut pas être programmée car aucune option de réinitialisation n’a été choisie.';
$string['reset_updated'] = 'Les paramètres de la prochaine réinitialisation annuelle des espaces-cours ont été modifiés.';
$string['reset_update_failed'] = 'L’enregistrement a échoué. Veuillez vérifier la date sélectionnée pour l’activation de la procédure et soumettre à nouveau vos modifications.';
$string['reset_how_to_activate'] = 'Cliquez sur « Activer » ci-dessous pour programmer l’exécution du script.';
$string['reset_is_activated'] = 'La prochaine réinitialisation sera exécutée le <strong>{$a}</strong>.';
$string['reset_not_activated'] = 'La réinitialisation n’est pas activée pour le moment.';
$string['reset_notifications_on_save'] = 'Les utilisateurs autorisés à programmer la réinitisalition de la plateforme seront notifiés par email des modifications apportées à la configuration.';
$string['reset_activation_failed'] = 'La tâche de réinitialisation des espaces-cours n’a pas pu être créée.';
$string['reset_desactivation_failed'] = 'La tâche de réinitialisation des espaces-cours n’a pas pu être supprimée.';
$string['reset_update_failed'] = 'La tâche de réinitialisation des espaces-cours n’a pas pu être reprogrammée.';
$string['reset_was_disabled'] = 'La tâche de réinitialisation des espaces-cours (rentrée {$a->year}) a été déprogrammée par {$a->userinfos}.';
$string['reset_was_enabled'] = 'La réinitialisation des espaces-cours a été programmée par {$a}.';
$string['reset_was_updated'] = 'La configuration de la tâche de réinitialisation des espaces-cours a été modifiée par {$a}.';
$string['reset_settings_for_activation'] = ' avec les paramètres suivants {$a}: ';
$string['reset_settings_currently_set'] = 'Voici les paramètres tels qu’ils sont actuellement définis {$a}: ';
$string['reset_settings_bold'] = '(en gras, les valeurs qui ont été modifiées) ';
...
$string['ws_value_activity_url'] = 'url de l’activité';
$string['ws_value_activityid'] = 'identifiant de l’activité';
$string['ws_value_area'] = 'nom de la zone géographique';
$string['ws_value_areaid'] = 'identifiant de la zone géographique';
...
$string['ws_value_city'] = 'nom du site';
$string['ws_value_cityid'] = 'identifiant du site';
$string['ws_value_course_name'] = 'nom du cours';
$string['ws_value_courseid'] = 'identifiant du cours';
$string['ws_value_datetime'] = 'horodatage du cours';
$string['ws_value_description'] = 'description de l’activité';
$string['ws_value_domain'] = 'nom du groupement d’activités';
$string['ws_value_domain_url'] = 'url du groupement d’activités';
$string['ws_value_domainid'] = 'identifiant du groupement d’activités';
...
$string['ws_value_idactivity'] = 'identifiant de l’activité'; // Deprecated. Remplaced by 'ws_value_activityid'.
$string['ws_value_idcourse'] = 'identifiant du cours'; // Deprecated. Remplaced by 'ws_value_courseid'.
$string['ws_value_idregistration'] = 'identifiant de l’inscription';
$string['ws_value_idteacher'] = 'identifiant de l’enseignant';
$string['ws_value_iduser'] = 'identifiant de l’utilisateur'; // Deprecated. Remplaced by 'ws_value_userid'.
...
$string['ws_value_location'] = 'nom du lieu de pratique';
$string['ws_value_locationid'] = 'identifiant du lieu de pratique';
$string['ws_value_message'] = 'message de type texte';
$string['ws_value_nbpresence'] = 'nombre de présences pour cette activité';
$string['ws_value_nbpresencecourse'] = 'nombre de présences dans ce cours';
...
$string['ws_value_period'] = 'nom de la période';
$string['ws_value_periodid'] = 'identifiant de la période';
$string['ws_value_role'] = 'rôle';
$string['ws_value_roles'] = 'rôles';
...
$string['ws_value_skill'] = 'niveau de pratique';
$string['ws_value_skillid'] = 'identifiant du niveau de pratique';
...
$string['ws_value_teacher'] = 'enseignant';
$string['ws_value_teachers'] = 'enseignants';
$string['ws_value_timestamp'] = 'horodatage du badgeage';
$string['ws_value_userid'] = 'identifiant de l’utilisateur';
...
$string['statistics_applicants'] = 'Candidats';
$string['statistics_enrollments'] = 'Inscriptions';
$string['statistics_enrolments_accepted'] = 'Affectations';
...
$string['statistics_groupe'] = 'Groupe';
$string['statistics_active_quota'] = 'Quota activé';
$string['statistics_day'] = 'Jour';
$string['statistics_address'] = 'Adresse';
$string['statistics_start'] = 'Début';
$string['statistics_end'] = 'Fin';
$string['statistics_start_the'] = 'Débute le';
$string['statistics_end_the'] = 'Termine le';
$string['statistics_id'] = 'Identifiant';
$string['statistics_enrollee_wish_list'] = 'Candidat Voeux';
$string['statistics_enrollees_userprofile'] = 'Nombre d’inscrits personnels VS nombre d’inscrits étudiants';
$string['statistics_enrollees_usergender'] = 'Nombre d’inscrits garçons VS nombre d’inscrits filles.';
$string['statistics_enrolments_userprofile'] = 'Nombre d’inscriptions personnels VS nombre d’inscriptions étudiants.';
$string['statistics_enrolments_usergender'] = 'Nombre d’inscriptions garçons VS nombre d’inscriptions filles.';
$string['statistics_enrolments_roles'] = 'Nombre d’inscriptions libres/Option évalués/Bonification évalués';
$string['statistics_nowishes_list'] = 'Visiteurs n’ayant pas fait de vœux';
$string['statistics_SHNU_list'] = 'Nombre de sportifs de haut-niveau par UFR';
$string['statistics_high_level_athletes'] = 'Sportifs de haut niveau inscrits sur l’espace cours';
$string['statistics_high_level_enrolments'] = 'Sportifs de haut niveau qui pratiquent une activité';
$string['statistics_dashboard_main'] = 'Activités physiques - chiffres-clés';
$string['statistics_dashboard_complementary'] = 'Activités complémentaires - chiffres-clés';
