 ...
 */
class local_apsolu_reports_federation_export_form extends moodleform {
    protected function definition() {
        ...
        $select = $mform->addElement('select', 'medicals', get_string('medical_certificate', 'local_apsolu_courses'), $medicals, array('size' => 4));
