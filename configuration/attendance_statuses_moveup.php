...
/**
 * Page permettant de monter la priorité d'un type de présence.
 *
...
if ($status->sortorder === '1') {
    // Vérifie que le type de présence n'est pas le premier élément.
    Notification::error(get_string('the_attendance_status_X_is_already_the_first_element', 'local_apsolu', $status->longlabel));
} else {
    try {
