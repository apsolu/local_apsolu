...
$urlarguments = array('page' => 'attendancestatuses', 'action' => 'delete', 'statusid' => $status->id, 'delete' => $deletehash);
...
// Bouton d'annulation.
$cancelurl = new moodle_url('/local/apsolu/configuration/index.php', array('page' => 'attendancestatuses'));
