...
/**
 * Page permettant de baisser la priorité d'un numéro d'association.
 *
...
if ($number->sortorder == $count - 1) {
    // Vérifie que le numéro d'association n'est pas le dernier élément.
    Notification::error(get_string('the_association_number_X_is_already_the_last_element', 'local_apsolu', $number->number));
} else {
    try {
        ...
        // Met à jour la position du numéro d'association situé après notre numéro d'association édité.
