...
class report extends \local_apsolu\local\statistics\report {
    ...
    public function __construct(){
      ...
      $this->WithEnrolments = 'WITH enrolments AS ( 
            ...
            CASE WHEN (U.email LIKE \'%@etudiant.univ-%\' OR U.email LIKE \'%@eleves.%\' OR U.email LIKE \'%@etud.univ-%\')  
            	THEN \'Étudiant\'
            ...
            CASE WHEN UE.status = 0 THEN "Liste des étudiants acceptés"
      			...
      			APSOLU_C.id as slotid, APSOLU_C.event as slotevent,APSOLU_C.weekday as slotweekday, APSOLU_C.starttime as slotstart,	APSOLU_C.endtime as slotend,
