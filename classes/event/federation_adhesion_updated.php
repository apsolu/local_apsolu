 ...
 */
class federation_adhesion_updated extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('adhesion_updated', 'local_apsolu');
    }
    ...
    public function get_description() {
        return 'The user with id ' . $this->userid . ' updated the federation adhesion' .
    ...
    public function get_url() {
        return new \moodle_url('/local/apsolu/federation/adhesion/index.php');
    }
}
