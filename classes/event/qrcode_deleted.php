...
/**
 * Enregistre la suppression d'un qrcode de validation de présence.
 *
 * @package   local_apsolu
 * @copyright 2025 Université Rennes 2
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qrcode_deleted extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('qr_code_deleted', 'local_apsolu');
    }
    ...
    public function get_description() {
        return 'The user with id ' . $this->userid . ' deleted the qrcode' .
