...
/**
 * Enregistre la mise à jour d'un paiement validé.
 *
 * @package    local_apsolu
 * @copyright  2026 Université Rennes 2
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class payment_approved extends \core\event\base {
    /**
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'apsolu_payments';
    }
    ...
    public static function get_name() {
        return get_string('payment_approved', 'local_apsolu');
    }
    ...
    public function get_description() {
        return 'The user #' . $this->userid . ' completed the payment #' . $this->objectid .
            ' for the user #' . $this->relateduserid;
    }
