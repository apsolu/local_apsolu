...
/**
 * Enregistre la mise à jour d'un paiement.
 *
 * @package    local_apsolu
 * @copyright  2026 Université Rennes 2
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class payment_updated extends \core\event\base {
    /**
    ...
    public function get_description() {
        ...
        return 'The user #' . $this->userid . ' updated the payment #' . $this->objectid .
            ' for the user #' . $this->relateduserid . '(cards: ' . implode(', ', $this->other->items) . ').';
    }
