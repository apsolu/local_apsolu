...
$PAGE->set_url('/local/apsolu/documentation.php');
...
foreach ($functions as $function) {
    if (strpos($function->name, 'local_apsolu') === false) {
        continue;
    }
...
echo "<h3>Exemple</h3><pre>$ curl -i --data 'wstoken=f3a6a20c55ad25c145dd3a65e3b32c89&amp;wsfunction=local_apsolu_get_teacherid&amp;teacherid=42' https://dev-jb.univ-rennes2.fr/apsu/webservice/rest/server.php</pre>";
