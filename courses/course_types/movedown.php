...
/**
 * Page permettant de baisser l'ordre d'un type de format de cours.
 *
...
if ($coursetype->sortorder == $count - 1) {
    // Vérifie que le numéro d'association n'est pas le dernier élément.
    Notification::error(get_string('the_element_X_is_already_the_last_element', 'local_apsolu', $coursetype->name));
} else {
    try {
