...
$data->cities = array_values($cities);
$data->count_cities = count($cities);

if (isset($notificationform)) {
    $data->notification = $notificationform;
}

echo $OUTPUT->render_from_template('local_apsolu/courses_cities', $data);
